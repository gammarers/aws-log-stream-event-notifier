...
| <code><a href="#@gammarers/aws-log-stream-event-notifier.LogStreamEventNotifier.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-log-stream-event-notifier.LogStreamEventNotifier.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-log-stream-event-notifier.LogStreamEventNotifier.with.parameter.mixins"></a>
